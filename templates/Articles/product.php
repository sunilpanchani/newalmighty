<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Products')) ?>
    ...
    <?= $this->element('body') ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Ecommerce', 'title' => 'Products')) ?>
                                ...
                                <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="product-img position-relative">
                                                    ...
                                                    <img src="/images/product/img-1.png" alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="product-img position-relative">
                                                    <img src="/images/product/img-2.png" alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="mt-4 text-center">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="product-img position-relative">
                                                    ...
                                                    <img src="/images/product/img-3.png" alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="mt-4 text-center">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="product-img position-relative">
                                                    ...
                                                    <img src="/images/product/img-5.png" alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="mt-4 text-center">
                                                    <h5 class="mb-3 text-truncate"><a href="javascript: void(0);" class="text-dark">Half sleeve T-Shirt</a></h5>
        ...
        <!-- init js -->
        <script src="/js/pages/product-filter-range.init.js"></script>
