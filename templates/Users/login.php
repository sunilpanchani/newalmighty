                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-lg-7">
                                                <div class="text-center">
                                                    ...
                                                    <h4 class="mb-3"><i class="bx bxs-quote-alt-left text-primary h1 align-middle me-3"></i><span class="text-primary">25k</span>+ Satisfied clients</h4>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="login" class="d-block auth-logo">
                                            <img src="/images/almighty/logo.png" alt="" height="165" class="auth-logo-dark">
                                            <img src="/images/almighty/logo.png" alt="" height="165" class="auth-logo-light">
                                        </a>
                                    </div>
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            <?= $this->Form->create(); ?>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="username" name="email" placeholder="Enter username" value="admin@themesbrand.com">
                                                </div>
