<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Contact Users List')) ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Contacts', 'title' => 'Users List')) ?>
                                            ...
                                            <table class="table align-middle table-nowrap table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                <img class="rounded-circle avatar-xs" src="/images/users/avatar-2.jpg" alt="">
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                <img class="rounded-circle avatar-xs" src="/images/users/avatar-3.jpg" alt="">
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                <img class="rounded-circle avatar-xs" src="/images/users/avatar-4.jpg" alt="">
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                <img class="rounded-circle avatar-xs" src="/images/users/avatar-5.jpg" alt="">
                                                            </div>
                                                        </td>
                                                        <td>
