<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Placeholders')) ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'UI Elements', 'title' => 'Placeholders')) ?>
                                        ...
                                        <div class="row gap-4">
                                            <div class="col-lg-5">
                                                <div class="card shadow-none border mb-0">
                                                    <img src="/images/small/img-1.jpg" class="card-img-top" alt="...">
