<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Form Elements')) ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Forms', 'title' => 'Form Elements')) ?>
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="mt-4">
                                                    ...
                                                    <p class="sub-header mb-4">Add class <code>.form-checkbox-outline</code> &
                                                        <code>.form-check-* </code> for a color Checkboxes</p>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="mt-4">
                                                    <h5 class="font-size-14"><i
                                                            class="mdi mdi-arrow-right text-primary me-1"></i> Form Radio
                                                        colors</h5>
