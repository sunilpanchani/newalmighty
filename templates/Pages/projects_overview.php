<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Project Overview')) ?>
    ...
    <?= $this->element('body') ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Project', 'title' => 'Project Overview')) ?>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-4">
                                                <img src="/images/companies/img-1.png" alt="" class="avatar-sm">
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 50px;"><img src="/images/users/avatar-2.jpg" class="rounded-circle avatar-xs" alt=""></td>
                                                    ...
                                                    <tr>
                                                        <td><img src="/images/users/avatar-4.jpg" class="rounded-circle avatar-xs" alt=""></td>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0 me-3">
                                                <img class="d-flex-object rounded-circle avatar-xs" alt="" src="/images/users/avatar-2.jpg">
                                            </div>
        ...
        <script src="/js/pages/project-overview.init.js"></script>
