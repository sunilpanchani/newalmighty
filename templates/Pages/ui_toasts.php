<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Toasts')) ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'UI Elements', 'title' => 'Toasts')) ?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                                ...
                                                <div class="position-fixed top-0 end-0 p-3" style="z-index: 1005">
                                                    <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                                                        <div class="toast-header">
                                                            <img src="/images/logo.svg" alt="" class="me-2" height="18">
                                            ...
                                            <!-- <div>
                                                <button type="button" class="btn btn-primary" id="liveToastBtn-1">Show live toast</button>
