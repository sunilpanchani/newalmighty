<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Blog Dashboard')) ?>
    ...
    <?= $this->element('body') ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Dashboards', 'title' => 'Blog')) ?>
                                                ...
                                                <div class="tab-pane active" id="post-recent" role="tabpanel">
                                                    <ul class="list-group list-group-flush">
                                                        <li class="list-group-item py-3">
                                                            <div class="d-flex">
                                                                <div class="me-3">
                                                                    <img src="/images/small/img-2.jpg" alt="" class="avatar-md h-auto d-block rounded">
                                                                </div>
                                                        ...
                                                        <li class="list-group-item py-3">
                                                            <div class="d-flex">
                                                                <div class="me-3">
                                                                    <img src="/images/small/img-1.jpg" alt="" class="avatar-md h-auto d-block rounded">
                                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 100px;"><img src="/images/small/img-2.jpg" alt="" class="avatar-md h-auto d-block rounded"></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><img src="/images/small/img-6.jpg" alt="" class="avatar-md h-auto d-block rounded"></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><img src="/images/small/img-1.jpg" alt="" class="avatar-md h-auto d-block rounded"></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><img src="/images/small/img-2.jpg" alt="" class="avatar-md h-auto d-block rounded"></td>
                                                        <td>
        ...
        <!-- dashboard blog init -->
        <script src="/js/pages/dashboard-blog.init.js"></script>
