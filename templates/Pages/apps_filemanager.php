<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'File Manager')) ?>
    ...
    <?= $this->element('body') ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Apps', 'title' => 'File Manager')) ?>
        ...
        <!-- file-manager js -->
        <script src="/js/pages/file-manager.init.js"></script>
