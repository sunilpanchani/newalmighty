<?= $this->element('main') ?>
    ...
    <head>
        ...
        <?= $this->element('title-meta', array('title' => 'Create Task')) ?>
    ...
    <?= $this->element('body') ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?= $this->element('page-title', array('pagetitle' => 'Tasks', 'title' => 'Create Task')) ?>
        ...
        <script src="/js/pages/task-create.init.js"></script>
